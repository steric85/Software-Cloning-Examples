...
public class AddCarPanel extends JPanel implements ActionListener
{
	...
	public CarDetailsComponents carComponents = new CarDetailsComponents();
...
//		carComponents.clearTextFields();
	...
	private void saveButtonClicked()
	{
		...
		try
		{
			...
			model = carComponents.getModelText();
			...
			{
				if (year >= 1000 && year <= 9999 && (year%3 == 0))
				{
...
//			myCar.setYear(year);
	 ...
	 * @return true if valid, false otherwise
	 */
	public boolean validateKilometers(String distance)
	{
		boolean valid = false;
		String rem;
