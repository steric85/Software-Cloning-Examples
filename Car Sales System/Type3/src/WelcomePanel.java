...
public class WelcomePanel extends JPanel implements ChangeListener
{
	...
	public JLabel carsLabel = new JLabel();
	public JLabel manufacturersLabel = new JLabel();
	public JLabel avgPriceLabel = new JLabel();
	public JLabel avgKmLabel = new JLabel();
	public JLabel avgAgeLabel = new JLabel();
	public JLabel versionLabel = new JLabel();
	public JLabel dataSizeLabel = new JLabel();
...
//		manufacturersLabel.setText("Total number of manufacturers: " + String.valueOf(manufacturers));
		...
		avgAgeLabel.setText(String.valueOf(avgAge));
