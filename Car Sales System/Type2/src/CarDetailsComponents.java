...
public class CarDetailsComponents extends JPanel implements ComponentListener
{
	...
	public JTextField manufacturerTextField = new JTextField();
	public JTextField yearTextField = new JTextField();
	public JTextField modelTextField = new JTextField();
	public JTextField priceTextField = new JTextField();
	public JTextField kmTextField = new JTextField();
	public JTextArea infoTextArea = new JTextArea(7, 0);

	private final int divFactor = 21;
	...
	public void clearTextFields()
	{
		manufacturerTextField.setText("manu");
	...
	public void componentResized(ComponentEvent ev)
	{
		if (ev.getSource() == this)
		{
			...
			if (width >= 0)
			{
				...
				infoTextArea.setColumns((width / divFactor) + 7); // this text box is larger
			}
		}
	}
